...
SECRET_KEY = 'django-insecure-_%ewur(+7-yj)roe&13wj5xleul^^luxe=q#wnh*03j+@*&ou6'
...
AUTH_USER_MODEL = 'users.CustomUser' # Points to your custom user model in the 'users' app
# Custom User Model
AUTH_USER_MODEL = 'users.CustomUser' # Points to your custom user model in the 'users' app
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated', # Default to authenticated access unless specified
    ],
